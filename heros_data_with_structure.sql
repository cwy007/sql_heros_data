...
CREATE TABLE `heros`  (
  ...
  `birthdate` date NULL DEFAULT NULL COMMENT '上线时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10069 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic COMMENT='王者荣耀数据表';
